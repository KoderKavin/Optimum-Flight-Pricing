...
**Predict-It** › **Streamlit UI & Docker** · `build_app/`
...
- **Live stream** — feeds `dataset/news.csv` with labels from `category_labels.json`
...
| UI shows raw codes (`0`, `1`) | Check `category_labels.json` was generated during training in [Step 3](../starter_kit/) |
| Live stream empty | Confirm `dataset/news.csv` exists (included in the Docker image) |
